		...
		const fakeProducts = [
			{
				...
				price: 89.99,
				category: "Hiking / Randonnée / Chaussures",
				inStock: true,
			...
			},
			{
				...
				price: 74.99,
				category: "Running / Course / Chaussures",
				inStock: true,
			...
			},
			{
				...
				price: 59.99,
				category: "Casual / Décontracté / Chaussures",
				inStock: false,
			...
			},
			{
				...
				price: 99.99,
				category: "Basketball / Basket / Chaussures",
				inStock: true,
			...
			},
			{
				...
				price: 84.99,
				category: "Soccer / Football / Chaussures",
				inStock: true,
